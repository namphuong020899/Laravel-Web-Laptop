...
@section('content')
	<div class="inner-header">
		<div class="container">
			<div class="pull-left">
				<h5 class="inner-title">Đặt hàng</h5>
			</div>
				...
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="form-block">
							...
							<input type="text"  name="address11223" placeholder="Street Address" required>
						</div>
					...
					<div class="col-sm-6">
						<div class="your-order">
									...
									<!--  one item	 -->
										<div class="media">
											...
											<div class="media-body">
												...
												<span class="color-gray your-order-info">Đơn giá: {{number_format($cart['price'])}} VNĐ</span><br>
							...
							<div class="text-center">
								...
								@else
								 <a href="{{route('trang-chu')}}"><i class="fa fa-angle-left" style="color: #337ab7"></i>Tiếp tục mua sắm</a>
								@endif
							</div>
						</div> <!-- .your-order -->
					</div>
